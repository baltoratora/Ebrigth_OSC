...
export default function SnrChapterPage() {
  ...
  const editor = useChapterEditor(`SNR-${label}`);
    ...
    return (
      <div className="w-full max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
          ...
          <button
            onClick={() => router.push(`/academy/syllabus/snr/${grade || 1}`)}
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4 mb-8">
        <button
          onClick={() => router.push(`/academy/syllabus/snr/${grade}`)}
          ...
          aria-label={`Back to SNR Grade ${grade}`}
        >
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          <button
            ...
            title="Save"
            onClick={() => editor.save()}
            className="p-2 rounded-full bg-amber-200 hover:bg-amber-300 text-amber-900 border border-amber-300 hover:border-amber-500 transition-colors"
          >
