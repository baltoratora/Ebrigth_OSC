...
export default function MdrChapterPage() {
  ...
  const editor = useChapterEditor(`MDR-${label}`);
  ...
  // Pagination: count A4 (1123px) pages so we can stamp a number on each.
    ...
    return (
      <div className="w-full max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
          ...
          <button
            onClick={() => router.push(`/academy/syllabus/mdr/${grade || 1}`)}
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4 mb-8">
        <button
          onClick={() => router.push(`/academy/syllabus/mdr/${grade}`)}
          ...
          aria-label={`Back to MDR Grade ${grade}`}
        >
        ...
        <button
          ...
          className={`ml-auto px-4 py-2 rounded-xl flex items-center gap-2 shadow-md font-bold text-sm transition-colors ${
            panelOpen
              ...
              : "bg-rose-100 text-rose-800 hover:bg-rose-800 hover:text-white"
          }`}
        >
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          <button
            ...
            title="Save"
            onClick={() => editor.save()}
            className="p-2 rounded-full bg-red-200 hover:bg-red-300 text-red-900 border border-red-300 hover:border-red-500 transition-colors"
          >
